...
int main(void)
{
  ...
  int playerMoves = 0, fleeInput = 0, eventCreate = 0, i, diceRoll, townInput = 0, fightRoll, attackCalculate;
			...
			scanf(" %i", &battleInput);
				...
				switch (battleInput)
				{
					case 1: 						
						...
						{
							Goblin.health = Goblin.health - ply->attack;
						...
						{
							Ghost.health = Ghost.health - ply->attack;
						...
						{
							Outlaw.health = Outlaw.health - ply->attack;
						...
						{
							Bandit.health = Bandit.health - ply->attack;
